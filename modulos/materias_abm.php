...
$sql=$materia->stringConsultaTabla();
...
if ($pagina->getCantRegistros() > 0) {
	...
	echo "<br><center><a href='main.php?mod=matform&act=a&page=$page'><font size=5>Clic aqui para Agregar</font></a>";
	echo "<table  border=1>";
	echo "<tr>";
	echo "<th colspan=4>MATERIAS</th>";
	echo "</tr>";
	echo "<tr>";
	echo "<th>NOMBRE</th>";
	...
	foreach($resultado as $row) {
		...
		echo "<td align='center'>".$row['horas_semanales']."</td>";
		echo "<td align='center'>";
		echo "<a href='main.php?mod=matform&cod=$id&act=v&page=$page'>Detalles</a>&nbsp;";
		echo "<a href='main.php?mod=matform&cod=$id&act=m&page=$page'>    Modificar    </a>&nbsp;";
		echo "<a href='main.php?mod=matform&cod=$id&act=b&page=$page'>Borrar</a>";
		echo "</td>";
		echo "</tr>";
	}
	...
	echo "No hay registros para mostrar. <a href='main.php?mod=matform&act=a&page=$page'>Agregar</a>";
